...
namespace CSharpEgitimKampi501
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection connection = new SqlConnection("Server=DESKTOP-NVTQEMT\\SQLEXPRESS;initial Catalog=EgitimKampi501Db;integrated security=true");
        ...
        private async void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            parameters.Add("@productId", txtProductId.Text);
            await connection.ExecuteAsync(query, parameters);
            MessageBox.Show("Kitap Güncelleme işlemi başarıyla yapıldı.", "Güncelleme", MessageBoxButtons.OK, MessageBoxIcon.Information);
