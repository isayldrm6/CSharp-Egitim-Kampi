...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblAvgCapacity.Text = (Math.Round((double)db.Location.Average(x => x.Capacity),2)).ToString();
            lblAvgLocationPrice.Text = (Math.Round((double)db.Location.Average(x => x.Price), 2)).ToString() + " ₺";
